      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildControlSection(
              'System Updates',
              'Force users and services to update before login',
              [
                _ControlItem(
                  icon: Icons.system_update,
                  title: 'Force Update Mode',
                  subtitle: 'Show "Need to Install New Version" message',
                  value: _forceUpdateMode,
                  onChanged: (value) => _toggleForceUpdateMode(value),
                ),
              ],
            ),
