...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _sendOTP() async {
    ...
    if (!_isValidEvsuEmail(email)) {
      _showErrorDialog(
        'Please enter a valid EVSU email address (@evsu.edu.ph)',
      );
      return;
    }
    ...
    try {
      final result = await SupabaseService.sendPasswordResetOTP(email: email);
  ...
  Future<void> _verifyOTP() async {
    ...
    if (otpCode.length != 6) {
      _showErrorDialog('OTP code must be 6 digits');
      return;
    }
    ...
    try {
      final result = await SupabaseService.verifyPasswordResetOTP(
        email: email,
        otpCode: otpCode,
      );
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      final result = await SupabaseService.resetPasswordWithOTP(
        email: email,
        otpCode: otpCode,
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Enter your @evsu.edu.ph email',
