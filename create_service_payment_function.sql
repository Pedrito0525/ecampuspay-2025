...
-- Grant permissions
GRANT EXECUTE ON FUNCTION process_service_payment(INTEGER, INTEGER, DECIMAL, JSONB, TEXT) TO service_role;
GRANT EXECUTE ON FUNCTION process_service_payment(INTEGER, INTEGER, DECIMAL, JSONB, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION process_service_payment(INTEGER, INTEGER, DECIMAL, JSONB, TEXT) TO anon;
